...
%\setlength\photoHeight{\heightof{\TypesetCoffin\Photo}}
%\typeout{Photo height: \the\photoHeight}
% Photo height: 180.2pt = 63.570556mm

\SetHorizontalCoffin\Title{%
  \resizebox{\photoWidth}{!}{\titleFont\titleSize\color[gray]{0.35}\soTitle{Dhammapada-Reflexionen}}%
}%
...
\begin{minipage}{\linewidth}%
  ...
  \vspace*{-7pt}%
  {\volumeFont\volumeSize\color[gray]{0.75}\soVolume{Band Eins}}
\end{minipage}%
}%
